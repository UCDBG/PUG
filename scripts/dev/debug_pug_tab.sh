...
${DEBUGGER} ${DEBUGOPT} ${PUG} ${LOG} -sql "${PROGRAM}" ${CONNECTION_PARAMS} ${ORACLE} ${PUG_DL_PLUGINS} -Pexecutor sql -whynot_adv -attr_dom -tabular -treeify-algebra-graphs FALSE ${*:3}
